...
class CadastroReurb(db.Model):
    ...
    # Etapa 2: Imóvel
    uso_imovel = db.Column(db.String(100), nullable=True)
...
class CalculoTributarioService:
    ...
    def calcular_valores(cadastro: CadastroReurb):
        ...
        try:
            ...
            # 4. Descobrir o Tipo de Uso
            # Agora a prioridade máxima é o uso definido para o imóvel inteiro
            tipo_uso = getattr(cadastro, 'uso_imovel', None) or getattr(cadastro, 'uso_principal', None)
